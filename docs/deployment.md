...
| `InvalidPackageConfig` / `paths.zippedPackage` missing | `config/package-solution.json` must have `solution.id`, `solution.name`, `paths.zippedPackage` non-empty string (`packages/sppkg-builder/src/sppkg-builder.ts:264`) |
